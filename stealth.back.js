function setDefaultAttr(key, name, l) {
  ...
  function changeFont() {
    var heightRand=Math.random()
    var widthRand=Math.random()
    const offsetHeight = Object.getOwnPropertyDescriptor(HTMLElement.prototype, 'offsetHeight');
    Object.defineProperty(HTMLElement.prototype, "offsetHeight", {
      ...offsetHeight,
      get() {
        return Math.floor(this.getBoundingClientRect().height)+heightRand
      }
    });
    ...
    Object.defineProperty(HTMLElement.prototype, "offsetWidth", {
      ...offsetWidth,
      get() {
        return Math.floor(this.getBoundingClientRect().width)+widthRand
      }
    });
  };
  function changeRect() {
    ...
    Object.defineProperty(DOMRect.prototype, "height", {
      ...height,
      get() {
        return Math.floor(this.toJSON()["height"]) + heightRand;
      },
    });
    ...
    Object.defineProperty(DOMRect.prototype, "width", {
      ...width,
      get() {
        return Math.floor(this.toJSON()["width"]) + widthRand;
      },
    });
  }
